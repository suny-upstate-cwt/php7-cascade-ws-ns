...
class M // messages for exceptions
{
    ...
    const EDIT_WORKFLOW_EMAIL_FAILURE    = "Failed to edit the workflow email. ";
    ...
    const EMPTY_WORKFLOW_EMAIL_SUBJECT   = "The workflow email subject cannot be empty. ";
    const EMPTY_WORKFLOW_EMAIL_BODY      = "The workflow email body cannot be empty. ";
...
class P // property names
{
    ...
    const WORKFLOW_EMAIL                      = "workflowEmail";
    const WORKFLOWEMAIL                       = "workflowEmail";
    const WORKFLOW_EMAIL_CONTAINER            = "workflowEmailContainer";
    const WORKFLOWEMAILCONTAINER              = "workflowEmailContainer";
...
class T // types
{
    ...
    public static $type_class_name_map = array(
            ...
            T::WORKFLOWEMAIL                    => 'WorkflowEmail',
            T::WORKFLOWEMAILCONTAINER           => 'WorkflowEmailContainer',
    ...
    public static $type_parent_type_map = array(
            ...
            T::WORKFLOWEMAIL                    => T::WORKFLOWEMAILCONTAINER,
            T::WORKFLOWEMAILCONTAINER           => T::WORKFLOWEMAILCONTAINER,
    ...
    public static $type_property_name_map = array(
            ...
            T::WORKFLOWEMAIL                    => P::WORKFLOWEMAIL,
            T::WORKFLOWEMAILCONTAINER           => P::WORKFLOWEMAILCONTAINER,
