...
<postscript><h2>Test Code</h2><ul><li><a href="https://github.com/suny-upstate-cwt/php-cascade-ws-ns-examples/blob/master/asset-class-test-code/destination.php">destination.php</a></li></ul>
<h2>JSON Dump</h2>
<pre>{ "asset":{
  "destination":{
